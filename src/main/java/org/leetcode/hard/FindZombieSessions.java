 ...
 *
 * @see <a href="https://leetcode.com/problems/find-zombie-sessions/">LeetCode #3673</a>
 */
public class FindZombieSessions {
    ...
    public Object solve(Object input) {
        throw new UnsupportedOperationException("Not yet implemented: Find Zombie Sessions");
    }

    public static void main(String[] args) {
        System.out.println("=== FindZombieSessions ===");
        FindZombieSessions sol = new FindZombieSessions();
