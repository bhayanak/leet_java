 ...
 * @see <a href="https://leetcode.com/problems/range-module/">Problem</a>
 */
public class RangeModule {
     ...
     * right), tracking every real number in that interval. Adding an interval
     ...
     * in the interval [left, right) is currently being tracked, and false
     * otherwise.
     * 
     ...
     * rangeModule.queryRange(16, 17); // return
     */
    // TODO: Implement solution for Range Module
    // Difficulty: HARD | Topics: Design, Segment Tree, Ordered Set
    /**
