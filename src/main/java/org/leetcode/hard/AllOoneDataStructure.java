 ...
 * @see <a href="https://leetcode.com/problems/all-oone-data-structure/">Problem</a>
 */
public class AllOoneDataStructure {
     ...
     * 
     * It is guaranteed that for each call to dec, key is existing in the data st
     */
    // TODO: Implement solution for All O`one Data Structure
    // Difficulty: HARD | Topics: Hash Table, Linked List, Design, Doubly-Linked List
    /**
