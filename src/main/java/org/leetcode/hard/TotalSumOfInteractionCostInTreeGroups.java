...
/**
 * <b>#3786 - Total Sum of Interaction Cost in Tree Groups</b>
 *
 ...
 * Hint 2: For each edge, contribution = <code>subtree_count * (total_count - subtree_count)</code>.
 * Hint 3: Sum these over all edges and groups.
 *
 * <h2>Approach</h2>
 * Think about the category (Array, Tree, Depth-First Search).
 *
 * @see <a href="https://leetcode.com/problems/total-sum-of-interaction-cost-in-tree-groups/">LeetCode #3786</a>
 */
public class TotalSumOfInteractionCostInTreeGroups {
    ...
    public Object solve(Object input) {
        throw new UnsupportedOperationException("Not yet implemented: Total Sum of Interaction Cost in Tree Groups");
    }

    public static void main(String[] args) {
        System.out.println("=== TotalSumOfInteractionCostInTreeGroups ===");
        TotalSumOfInteractionCostInTreeGroups sol = new TotalSumOfInteractionCostInTreeGroups();
