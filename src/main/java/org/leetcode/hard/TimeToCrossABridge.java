...
/**
 * <b>#2532 - Time to Cross a Bridge</b>
 *
 ...
 * Hint 1: Try simulating this process.
 * Hint 2: We can use a priority queue to query over the least efficient worker.
 *
 * <h2>Approach</h2>
 * Think about the category (Array, Heap (Priority Queue), Simulation).
 *
 * @see <a href="https://leetcode.com/problems/time-to-cross-a-bridge/">LeetCode #2532</a>
 */
public class TimeToCrossABridge {
    ...
    public Object solve(Object input) {
        throw new UnsupportedOperationException("Not yet implemented: Time to Cross a Bridge");
    }

    public static void main(String[] args) {
        System.out.println("=== TimeToCrossABridge ===");
        TimeToCrossABridge sol = new TimeToCrossABridge();
