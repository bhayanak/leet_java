 ...
 * @see <a href="https://leetcode.com/problems/smallest-rotation-with-highest-score/">Problem</a>
 */
public class SmallestRotationWithHighestScore {
     ...
     * than or equal to their index are worth one point.
     * 
     * 
     ...
     */
    // TODO: Implement solution for Smallest Rotation with Highest Score
    // Difficulty: HARD | Topics: Array, Prefix Sum
    /**
    ...
    public static void main(String[] args) {
        SmallestRotationWithHighestScore sol = new SmallestRotationWithHighestScore();
