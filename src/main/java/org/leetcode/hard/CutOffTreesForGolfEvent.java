 ...
 * @see <a href="https://leetcode.com/problems/cut-off-trees-for-golf-event/">Problem</a>
 */
public class CutOffTreesForGolfEvent {
     ...
     * south, and west. If you are standing in a cell with a tree, you can choose
     ...
     * Con
     */
    // TODO: Implement solution for Cut Off Trees for Golf Event
    // Difficulty: HARD | Topics: Array, Breadth-First Search, Heap (Priority Queue), Matrix
    /**
    ...
    public static void main(String[] args) {
        CutOffTreesForGolfEvent sol = new CutOffTreesForGolfEvent();
