 ...
 * @see <a href="https://leetcode.com/problems/shortest-completing-word/">Problem</a>
 */
public class ShortestCompletingWord {
    ...
    public String shortestCompletingWord(String licensePlate, String[] words) {
        ...
        for (String word : words) {
            ...
            for (char c : word.toLowerCase().toCharArray()) count[c - 'a']++;
            boolean ok = true;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sol.shortestCompletingWord("hello", new String[]{"a","b"}));
    }
}
