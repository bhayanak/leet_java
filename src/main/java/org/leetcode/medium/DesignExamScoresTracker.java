...
/**
 * <b>#3709 - Design Exam Scores Tracker</b>
 *
 * <p><b>Difficulty:</b> Medium</p>
 * <p><b>Category:</b> Array, Binary Search, Design, Prefix Sum</p>
 *
 ...
 * Hint 1: Maintain two arrays: <code>times</code> (append each <code>time</code>) and <code>prefix</code> where <code>prefix[i]</code> is sum of scores up to index <code>i</code>.
 * Hint 2: Use binary search to find indices: <code>l = lower_bound(times, startTime)</code> and <code>r = upper_bound(times, endTime) - 1</code>.
 * Hint 3: If <code>l &gt; r</code> there are no exams, so return <code>0</code>; otherwise compute total using the <code>prefix</code>.
 *
 * <h2>Approach</h2>
 * Think about the category (Array, Binary Search, Design, Prefix Sum).
 *
 * @see <a href="https://leetcode.com/problems/design-exam-scores-tracker/">LeetCode #3709</a>
 */
public class DesignExamScoresTracker {
    ...
    public Object solve(Object input) {
        throw new UnsupportedOperationException("Not yet implemented: Design Exam Scores Tracker");
    }

    public static void main(String[] args) {
        System.out.println("=== DesignExamScoresTracker ===");
        DesignExamScoresTracker sol = new DesignExamScoresTracker();
