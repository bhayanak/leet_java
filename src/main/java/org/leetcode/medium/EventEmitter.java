 ...
 *
 * @see <a href="https://leetcode.com/problems/event-emitter/">LeetCode #2694</a>
 */
public class EventEmitter {
    ...
    public Object solve(Object input) {
        throw new UnsupportedOperationException("Not yet implemented: Event Emitter");
    }

    public static void main(String[] args) {
        System.out.println("=== EventEmitter ===");
        EventEmitter sol = new EventEmitter();
