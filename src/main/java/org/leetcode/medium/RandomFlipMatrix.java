 ...
 * @see <a href="https://leetcode.com/problems/random-flip-matrix/">Problem</a>
 */
public class RandomFlipMatrix {
     ...
     * 
     * At most 1000 calls will be mad
     */
    // TODO: Implement solution for Random Flip Matrix
    // Difficulty: MEDIUM | Topics: Hash Table, Math, Reservoir Sampling, Randomized
    /**
    ...
    public static void main(String[] args) {
        RandomFlipMatrix sol = new RandomFlipMatrix();
