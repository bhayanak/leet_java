 ...
 *
 * @see <a href="https://leetcode.com/problems/find-loyal-customers/">LeetCode #3657</a>
 */
public class FindLoyalCustomers {
    ...
    public Object solve(Object input) {
        throw new UnsupportedOperationException("Not yet implemented: Find Loyal Customers");
    }

    public static void main(String[] args) {
        System.out.println("=== FindLoyalCustomers ===");
        FindLoyalCustomers sol = new FindLoyalCustomers();
