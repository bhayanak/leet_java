...
/**
 * <b>#3603 - Minimum Cost Path with Alternating Directions II</b>
 *
 ...
 * Hint 2: Observe that you need to wait at each cell except the first and last
 * Hint 3: Transition: <code>dp[i][j]</code> &lt;- min(<code>dp[i‑1][j]</code>, <code>dp[i][j‑1]</code>) + <code>waitCost[i][j]</code> + (<code>i+1</code>)*(<code>j+1</code>)
 * Hint 4: The answer is <code>dp[m‑1][n‑1]</code> - <code>waitCost[m‑1][n‑1]</code>
 *
 * <h2>Approach</h2>
 * Think about the category (Array, Dynamic Programming, Matrix).
 *
 * @see <a href="https://leetcode.com/problems/minimum-cost-path-with-alternating-directions-ii/">LeetCode #3603</a>
 */
public class MinimumCostPathWithAlternatingDirectionsIi {
    ...
    public Object solve(Object input) {
        throw new UnsupportedOperationException("Not yet implemented: Minimum Cost Path with Alternating Directions II");
    }

    public static void main(String[] args) {
        System.out.println("=== MinimumCostPathWithAlternatingDirectionsIi ===");
        MinimumCostPathWithAlternatingDirectionsIi sol = new MinimumCostPathWithAlternatingDirectionsIi();
