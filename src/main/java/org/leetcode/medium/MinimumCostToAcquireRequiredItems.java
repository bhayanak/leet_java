...
/**
 * <b>#3789 - Minimum Cost to Acquire Required Items</b>
 *
 ...
 * Hint 1: First, use <code>min(costBoth, cost1 + cost2)</code> for <code>min(need1, need2)</code>.
 * Hint 2: For the remaining type 1 requirement <code>rem1</code>, use cost <code>min(costBoth, cost1)</code> for the rest.
 * Hint 3: Do the same for type 2, using cost <code>min(costBoth, cost2)</code>.
 *
 * <h2>Approach</h2>
 * Think about the category (Math, Greedy).
 *
 * @see <a href="https://leetcode.com/problems/minimum-cost-to-acquire-required-items/">LeetCode #3789</a>
 */
public class MinimumCostToAcquireRequiredItems {
    ...
    public Object solve(Object input) {
        throw new UnsupportedOperationException("Not yet implemented: Minimum Cost to Acquire Required Items");
    }

    public static void main(String[] args) {
        System.out.println("=== MinimumCostToAcquireRequiredItems ===");
        MinimumCostToAcquireRequiredItems sol = new MinimumCostToAcquireRequiredItems();
