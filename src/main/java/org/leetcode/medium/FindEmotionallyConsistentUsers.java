...
/**
 * <b>#3808 - Find Emotionally Consistent Users</b>
 *
 ...
 *
 * @see <a href="https://leetcode.com/problems/find-emotionally-consistent-users/">LeetCode #3808</a>
 */
public class FindEmotionallyConsistentUsers {

    /**
     * Solves the problem: Minimum deletions.
     *
    ...
    public int minimumDeletions(String s) {
        ...
        for (char c:s.toCharArray()) {
            if (c=='a') b=Math.min(a,b); // delete a after b
            else a++; // delete b before a
        }
        return Math.min(a+b,s.length());
    }

    public static void main(String[] args) {
        FindEmotionallyConsistentUsers sol = new FindEmotionallyConsistentUsers();
        System.out.println(sol.minimumDeletions("hello"));
    }
}
