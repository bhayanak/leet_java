 ...
 * @see <a href="https://leetcode.com/problems/asteroid-collision/">Problem</a>
 */
public class AsteroidCollision {
     ...
     * row. The indices of the asteroid in the array represent their relative
     * position in space.
     * 
     * 
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sol.asteroidCollision(new int[]{1,2,3}));
    }
}
