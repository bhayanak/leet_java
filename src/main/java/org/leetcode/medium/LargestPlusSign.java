 ...
 * @see <a href="https://leetcode.com/problems/largest-plus-sign/">Problem</a>
 */
public class LargestPlusSign {
     ...
     * made of 1's. Note that there could be 0's or 1's beyond the arms of the
     ...
     */
    // TODO: Implement solution for Largest Plus Sign
    ...
    public static void main(String[] args) {
        LargestPlusSign sol = new LargestPlusSign();
