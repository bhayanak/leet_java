 ...
 * @see <a href="https://leetcode.com/problems/queue-reconstruction-by-height/">Problem</a>
 */
...
If the position of the shortest person is i, how many people would be in front of the shortest person?
    ...
    /**
     * Solves the problem: Reconstruct queue.
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sol.reconstructQueue(new int[][]{{1,2},{3,4}}));
    }
}
