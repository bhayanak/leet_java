 ...
 *
 * <h2>Approach</h2>
 * Greedy: use a table of value→symbol pairs in descending order.
 * Repeatedly subtract the largest value that fits; append its symbol.
 *
 * <h2>Complexity</h2>
* Time: O(1) — bounded by max value 3999  |  Space: O(1)
 *
 * @see <a href="https://leetcode.com/problems/integer-to-roman/">LeetCode #12</a>
 */
