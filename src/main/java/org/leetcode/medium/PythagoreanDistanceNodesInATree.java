...
/**
 * <b>#3820 - Pythagorean Distance Nodes in a Tree</b>
 *
 * <p><b>Difficulty:</b> Medium</p>
 * <p><b>Category:</b> Tree, Breadth-First Search</p>
 *
 ...
 * Hint 1: Run a breadth-first search independently from <code>x</code>, <code>y</code>, and <code>z</code>. This gives you three distance arrays with full coverage.
 * Hint 2: For each node, collect its three distances, sort them, and evaluate the Pythagorean condition on the sorted value.
 *
 * <h2>Approach</h2>
 * Think about the category (Tree, Breadth-First Search).
 *
 * @see <a href="https://leetcode.com/problems/pythagorean-distance-nodes-in-a-tree/">LeetCode #3820</a>
 */
public class PythagoreanDistanceNodesInATree {
    ...
    public Object solve(Object input) {
        throw new UnsupportedOperationException("Not yet implemented: Pythagorean Distance Nodes in a Tree");
    }

    public static void main(String[] args) {
        System.out.println("=== PythagoreanDistanceNodesInATree ===");
        PythagoreanDistanceNodesInATree sol = new PythagoreanDistanceNodesInATree();
